...
const Table2 = () => {
    ...
    return (
        <>
            <Table className="border border-red-600 rounded-t-2xl overflow-hidden">
                <TableHeader className="px-5 bg-gray-100">
                    <TableRow>
            ...
            <div className="flex justify-between items-center border w-full bg-gray-100 rounded-b-2xl px-4 py-2">
                <div>1</div>
